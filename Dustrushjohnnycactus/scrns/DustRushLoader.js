...
const DustRushLoader = () => {
  ...
  _uEF_7qPzLxVnT3mA9rKb(() => {
    const _tL_3aKsQpLxVnZ8tRm2 = setTimeout(() => {
      _sShL_7nR3aKsQpLxV8tZm(false);
      _sShI_9tVmQpLxZ7nR3aKs(true);
    }, 5000);
    ...
    return () => {
      clearTimeout(_tL_3aKsQpLxVnZ8tRm2);
  ...
  return (
    ...
    >
      ...
      >
        {_shI_4pLxQnZ8tVmR2aKs && (
          <_vW_9tVmQpLxZ7nR3aKs
            style={_d$.lW_7qPzLxVnT3mA9rKb}
            accessibilityLabel="loader-screen"
          >
            <_iMg_4pLxQnZ8tVmR2aKs
              source={require('../../assets/images/dustloaderLogo.png')}
